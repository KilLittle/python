...
inputt_list = [2, 2, 2, 7, 23, 1, 44, 44, 3, 2, 10, 7, 4, 11]
print(f"Исходный список: {inputt_list}")
print(f"Без повторений: {[el for el in inputt_list if inputt_list.count(el) == 1]}")