...
за приём оргтехники на склад и передачу в определённое подразделение компании. Для хранения данных о наименовании и
количестве единиц оргтехники, а также других данных, можно использовать любую подходящую структуру (например,
словарь).
...
class OfficeEquipment:
    ...
    def reception(self):
        try:
            ...
            unique = {'Наименование': unit, 'Цена': unit_p, 'Количество': unit_q}
...
unit_1 = Printer('hp', 200, 5, 10)
unit_2 = Scanner('Canon', 120, 5, 10)
unit_3 = Copier('Xerox', 500, 1, 15)
